            ...
            <div className="nm-card p-4 mb-4 flex flex-wrap gap-3" data-aos="fade-up">
                <div className="flex-1 min-w-48 relative">
                    ...
                    <input
                        ...
                        onKeyDown={(e) =>
                            e.key === 'Enter' && applyFilters({ search: e.target.value })
                        }
                    />
                </div>
                <select
                ...
                <select
                    ...
                    onChange={(e) => {
                        ...
                        applyFilters({ vehicle_type: e.target.value });
                    }}
                >
                ...
                <select
                    ...
                    onChange={(e) => {
                        ...
                        applyFilters({ session_status: e.target.value });
                    }}
                >
                    <option value="">All Sessions</option>
                    <option value="not_started">Not Started</option>
                    <option value="ongoing">In Progress</option>
                    <option value="completed">Sessions Done</option>
                </select>
            </div>
                        ...
                        <tbody>
                            ...
                            {students.data?.map((s) => {
                                const prog = Math.round(
                                    (s.completed_sessions / s.total_sessions) * 100
                                );
                                return (
                                    <tr key={s.id}>
                                        <td>
                                            <div className="flex items-center gap-3">
                                                <img
                                                    src={`https://ui-avatars.com/api/?name=${encodeURIComponent(s.name)}&color=D4AF37&background=000666&size=64`}
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-muted">
                                                        {s.student_id} · {s.phone}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="text-xs text-muted capitalize">
                                            {s.vehicle_type}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                className={`text-xs px-2 py-0.5 rounded-full ${
                                                    s.llr_record?.llr_status === 'passed'
                                                        ? 'badge-active'
                                                        : s.llr_record?.llr_status === 'not_applied'
                                                          ? 'badge-danger'
                                                          : 'badge-pending'
                                                }`}
                                            >
                                                {s.llr_record?.llr_status?.replace(/_/g, ' ') ||
                                                    'N/A'}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <Link
                                                href={route('teacher.students.edit', s.id)}
