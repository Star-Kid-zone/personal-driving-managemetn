...
export default function TeacherTripCreate({ vehicles, students }) {
    ...
    const submit = (e) => { e.preventDefault(); post(route('teacher.trips.store')); };
                ...
                <form onSubmit={submit}>
                    <div className="nm-card p-6 space-y-4" data-aos="fade-up">
                        <h2 className="text-lg font-semibold text-white flex items-center gap-2 mb-2">
                            <Route size={18} className="text-[#D4AF37]" /> Schedule a Trip
                        </h2>
                        ...
                        <div>
                            ...
                            {filteredStudents.length === 0 ? (
                                <div className="text-center py-8 text-muted text-sm rounded-xl" style={{ background: 'rgba(255,255,255,0.03)' }}>
                                    No active {data.vehicle_type} students with remaining sessions
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-60 overflow-y-auto scrollbar-hide p-0.5">
                    ...
                    <div className="flex justify-end gap-3 mt-4">
                        <a href={route('teacher.trips.index')} className="btn-ghost">Cancel</a>
