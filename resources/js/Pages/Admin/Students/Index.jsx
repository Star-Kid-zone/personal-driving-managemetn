                        ...
                        <tbody>
                            ...
                            {students.data?.map((s) => (
                                <tr key={s.id}>
                                    ...
                                    <td>
                                        <VehicleBadge type={s.vehicle_type} />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <PayBadge status={s.payment?.payment_status} />
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td>
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <Link
                                                href={route('admin.students.edit', s.id)}
